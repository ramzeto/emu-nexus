...
void GameEditDialog::signalSearchButtonClicked(GtkButton *button, gpointer gameEditDialog)
{    
    ((GameEditDialog *)gameEditDialog)->search();
}

void GameEditDialog::signalFileNameButtonClicked(GtkButton *button, gpointer gameEditDialog)
{
    ((GameEditDialog *)gameEditDialog)->selectFileName();
}

void GameEditDialog::signalAddDeveloperButtonClicked(GtkButton *button, gpointer gameEditDialog)
{
...
void GameEditDialog::signalAddPublisherButtonClicked(GtkButton *button, gpointer gameEditDialog)
{
...
void GameEditDialog::signalAddGenreButtonClicked(GtkButton *button, gpointer gameEditDialog)
{
...
void GameEditDialog::signalImageTypeComboBoxChanged(GtkComboBox *comboBox, gpointer gameEditDialog)
{
    ((GameEditDialog *)gameEditDialog)->updateGameImageType();
}

void GameEditDialog::signalRemoveImageButtonClicked(GtkButton *button, gpointer gameEditDialog)
{
...
void GameEditDialog::signalDocumentTypeComboBoxChanged(GtkComboBox *comboBox, gpointer gameEditDialog)
{
    ((GameEditDialog *)gameEditDialog)->updateGameDocumentType();
}

void GameEditDialog::signalRemoveDocumentButtonClicked(GtkButton *button, gpointer gameEditDialog)
{
...
gboolean GameEditDialog::signalDocumentNameEntryKeyReleaseEvent(GtkEntry* entry, GdkEvent *event, gpointer gameEditDialog)
{    
...
void GameEditDialog::signalCancelButtonClicked(GtkButton *button, gpointer gameEditDialog)
{
    ((GameEditDialog *)gameEditDialog)->cancel();
}

void GameEditDialog::signalSaveButtonClicked(GtkButton *button, gpointer gameEditDialog)
{
...
void GameEditDialog::downloadGameImage(GameEditDialog *gameEditDialog, GameImage *gameImage)
{
    ...
    if(!downloadingGameImages)
    {
        ...
        {
            cerr << "GameEditDialog::" << __FUNCTION__ << endl;
            exit(EXIT_FAILURE);
        }
    }
    pthread_mutex_unlock(&downloadGameImageRefsMutex);
...
void *GameEditDialog::downloadGameImagesWorker(void *)
{
...
void GameEditDialog::callbackDownloadGameImage(void *pDownloadGameImageRef)
{
    ...
    if(downloadGameImageRef->gameEditDialog->dismissed)
    {
        ...
        if(!isDialog)
        {
            if(downloadGameImageRef->gameEditDialog->saved)
            {
                NotificationManager::getInstance()->postNotification(NOTIFICATION_GAME_UPDATED, new Game(*(downloadGameImageRef->gameEditDialog->game)));    
            }
