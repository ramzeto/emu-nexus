...
private:
    ...
    static void signalCloseButtonClicked(GtkButton *button, gpointer selectFromListDialog);    
    static void signalListRowSelected (GtkListBox *listBox, GtkWidget *row, gpointer selectFromListDialog);
};
