...
<span size="large">For multidisk games, if multiple .cue files are present in a compressed/packed ROM, a <b>00000_autogenerated.m3u</b> file, with all the .cue files referenced in order, is generated, so this ROM can be easily launched using emulators like <a href="https://libretro.readthedocs.io/en/latest/library/beetle_saturn/">Retroarch with the Beetle Saturn core</a>.</span>
